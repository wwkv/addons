 ...
 */
export default function ProcessingFlow({ txs, cats, autoCat, catUsage, blacklist, onAddToBlacklist, assign, bulkAssign, onSkip, onUndo, unassignedSavings, onClose, onGoToSavings }) {
